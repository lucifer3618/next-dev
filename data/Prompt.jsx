...
Generate a Project in React with js as file extention. Create multiple components, organizing them in separate folders with filenames using the .js extension, if needed. The output should use Tailwind CSS for styling, 
...
- **DO NOT CREATE THE PROJECT WITHIN /src/ FOLDER**
